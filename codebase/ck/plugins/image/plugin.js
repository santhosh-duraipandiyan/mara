...
/* Modified to suit Mara CMS by IWR Consultancy. 
   Requires (in addition to standard dependencies):
     Image alignment styles in stylesheet 
     Zoom javascript
     Captioning php code  
*/
...
( function() {
	...
	CKEDITOR.plugins.add( 'image', {
      ...
      // Mara - Possibly override these to prevent toolbar buttons from altering image alignment? Or modify action to add classes? 
