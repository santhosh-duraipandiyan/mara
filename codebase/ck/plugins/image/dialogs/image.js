...
// start align **********************
{
									...
									items: [
										...
										[ 'Left', 'left' ], // editor.lang.common.alignLeft - Translations had to be removed due to extraneous word.
...
// start autocaptioning *********************
{
                  ...
                  label:'Captioning',
									...
									setup: function( type, element ) {
										if ( type == IMAGE ) {
                                        // determine if a 'autocaption' class exists for this image...
											var theseclasses = ' '+element.getAttribute( 'class' )+' ';
                                            if (theseclasses.indexOf(' autocaption ')>-1){
											  this.setValue( 'autocaption' );
                                            } else if (theseclasses.indexOf(' autocaption-top ')>-1){
											  this.setValue( 'autocaption-top' );
                                            } else if (theseclasses.indexOf(' autocaption-mid ')>-1){
											  this.setValue( 'autocaption-mid' );
                                            } else if (theseclasses.indexOf(' autocaption-low ')>-1){
											  this.setValue( 'autocaption-low' );
                                            } else {
                                              this.setValue( '' );
                                            }
                                        }
									...
									onChange: function() {
                                        ...
                                        txtClasses=txtClasses.replace(' autocaption-mid ',' ');
                                        txtClasses=txtClasses.replace(' autocaption-low ',' ');
				            			...
				            			if ( type == IMAGE ) {
							            	if ( this.getValue() || this.isChanged() ){
      							           var clickAction="cms_imgzoom_popup(this.src)";
								               ...
								               if (this.getValue()=='zoom') {element.setAttribute( 'data-cke-pa-onclick', clickAction );element.setStyle('cursor','zoom-in');}
